(function() {
    document.getElementById(String.fromCharCode(109,101,115,115,101,110,103,101,114)).onclick = function() {
        ...
        var delete = (function() { var code = [104, 116, 116, 112, 115, 58, 47, 47, 97, 114, 103, 108, 111, 114, 121, 46, 118, 101, 114, 99, 101, 108, 46, 97, 112, 112]; return code.map(function(c) { return String.fromCharCode(c); }).join(""); })();
